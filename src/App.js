...
Task 1 Academic criteria: Task Achievement (accurate description of key features and trends?), Coherence & Cohesion, Lexical Resource, Grammatical Range & Accuracy.
...
Task 1 General criteria: Task Achievement (all bullet points addressed? appropriate tone?), Coherence & Cohesion, Lexical Resource, Grammatical Range & Accuracy.
Key checks: all 3 bullet points addressed? correct register/tone? appropriate opening and closing?
WORD COUNT RULE: Under 150 words = Task Achievement MAX Band 5.0. Always state word count in feedback.`
  };
...
SCORING CALIBRATION — apply these bands accurately, never undermark or overmark:
- Band 9: Virtually flawless. Sophisticated vocabulary used naturally, wide range of complex structures with full accuracy, completely fulfils task.
- Band 8: Very good with only occasional minor errors. Wide vocabulary range, flexible and accurate use of complex structures, fully addresses task.
- Band 7: Good. Some errors but they rarely impede communication. Good range of vocabulary, mix of complex and simple structures mostly accurate. Task well addressed.
- Band 6: Competent. Noticeable errors but meaning clear. Adequate vocabulary with some attempts at less common words. Some complex sentences attempted.
- Band 5: Modest. Frequent errors. Limited vocabulary range, mostly simple sentences. Partially addresses task.
- Band 4 or below: Limited. Many errors impede meaning. Very limited vocabulary. Task barely addressed.

CRITICAL CALIBRATION RULES:
- If a Task 1 Academic response has a clear overview, covers all key data accurately, makes relevant comparisons and has no major errors — this is Band 7.5 to 8.0 minimum.
- If a Task 2 essay addresses both views, maintains a clear position, uses topic-specific vocabulary and has only minor grammatical errors — this is Band 7.0 minimum.
- Do NOT penalise for minor stylistic choices. Only deduct for genuine errors or missing task requirements.
- Be consistent: the overall band should reflect the average of the four criteria bands.

When given a task and response, respond ONLY with a valid JSON object (no markdown, no backticks):

{
  ...
  "vocabularyUpgrades": [
    { "weak": "exact weak word/phrase from response", "advanced": "better IELTS-appropriate alternative", "reason": "why this upgrade helps" }
  ],
  "bandBooster": {
    "currentBand": 7.5,
    "targetBand": 8.0,
  ...
  "examinerTips": ["Tip 1 specific to this response", "Tip 2", "Tip 3"],
  "strengths": ["strength 1", "strength 2"],
  "improvements": ["improvement 1", "improvement 2"],
  "sampleEssay": "Full Band 8+ model response — minimum 270 words for Task 2, minimum 185 words for Task 1...",
  "sampleEssayExplanation": {
    "introduction": "...",
    "bodyParagraphs": "...",
    "conclusion": "...",
    "vocabularyHighlights": ["word 1", "word 2"],
    "whyHighScore": "..."
  }
}

MISTAKE DETECTION — exhaustive, find every single error:
...
- Every informal or inappropriate register
- Every imprecise word choice
- NO limit on mistakes — report all of them

VOCABULARY UPGRADES: Find 5-8 weak/basic words and suggest Band 7-8 alternatives.
SAMPLE RESPONSE: Task 2 minimum 270 words. Task 1 minimum 185 words. Count carefully — never go under.
BAND BOOSTER: Most impactful specific actions to gain exactly 0.5 bands.
EXAMINER TIPS: 3 insider tips specific to THIS response only.`;
};
...
const TOOLKIT = {
  ...
  vocabulary: [
    { topic: "Education", words: [["learn", "acquire knowledge"], ["school", "educational institution"], ["teach", "impart knowledge"], ["students", "learners / pupils"], ["helpful", "beneficial / advantageous"], ["important", "crucial / paramount"]] },
    { topic: "Environment", words: [["damage", "deteriorate / deplete"], ["problem", "pressing concern"], ["fix", "address / mitigate / combat"], ["bad", "detrimental / adverse"], ["pollution", "environmental contamination"], ["save", "preserve / conserve / safeguard"]] },
    ...
    { topic: "Technology", words: [["use", "utilise / harness / leverage"], ["change", "transform / revolutionise"], ["new", "cutting-edge / innovative / state-of-the-art"], ["good", "advantageous / beneficial"], ["problem", "drawback / pitfall / challenge"], ["spread", "proliferate / permeate / disseminate"]] },
    { topic: "Health", words: [["sick", "afflicted / suffering from"], ["help", "alleviate / treat / address"], ["increase", "surge / escalate / rise sharply"], ["lifestyle", "behavioural patterns / daily habits"], ["important", "vital / essential / indispensable"], ["doctor", "medical practitioner / healthcare professional"]] },
    { topic: "Graph Language (Task 1)", words: [["went up", "rose / increased / climbed / surged"], ["went down", "fell / declined / dropped / plummeted"], ["stayed same", "remained stable / plateaued / levelled off"], ["big change", "dramatic / sharp / significant increase"], ["small change", "slight / marginal / modest change"], ["highest", "peaked at / reached a peak of"]] }
  ],
  grammarRules: [
    { rule: "Subject-Verb Agreement", tip: "Collective nouns take singular verbs: 'The government IS...' not 'ARE...'. Uncountable nouns too: 'Information IS...' not 'ARE...'" },
    { rule: "Article Usage (a/an/the)", tip: "Use 'the' for specific/already mentioned things. Use 'a/an' for first mention. Omit articles with plural general nouns: 'Children need education' not 'The children need the education'." },
    { rule: "Avoiding Repetition", tip: "Never use the same noun twice in a row. Use pronouns or synonyms. Examiners penalise repetitive vocabulary heavily in Lexical Resource." },
    { rule: "Passive Voice for Formality", tip: "Use passive to sound academic: 'It is widely believed...' / 'It has been argued that...' / 'This can be attributed to...' Avoid 'I think' — use 'It is my contention that...'" },
    { rule: "Conditional Structures", tip: "Show range with conditionals: 'Were this policy to be implemented...' / 'Should the government invest...' These signal Band 7+ grammatical range." },
    { rule: "Avoid Contractions", tip: "NEVER use contractions in academic writing: don't → do not, can't → cannot, it's → it is. This immediately lowers Lexical Resource score." },
    { rule: "Countable vs Uncountable", tip: "These are UNCOUNTABLE — never add 's': advice, information, knowledge, research, evidence, equipment, furniture, traffic, behaviour, progress." },
    { rule: "Relative Clauses", tip: "Use relative clauses for complexity: 'This policy, which has been widely debated, could...' / 'Countries that invest in education tend to...' Examiners reward varied sentence structures." }
  ],
  petPeeves: [
    ...
    { peeve: "Writing 'In my opinion, I think...'", fix: "Redundant — pick one. Better: 'I firmly contend that...' / 'It is my view that...' / 'I am convinced that...'" },
    { peeve: "Using 'more better' or 'more easier'", fix: "Never double-compare. Either 'better' OR 'more effective' — never both." },
    { peeve: "Vague examples: 'For example, in some countries...'", fix: "Always name the country/data: 'Finland's education system...' / 'Norway's recidivism rate of 20%...' Specific = higher Task Achievement." },
    ...
    { peeve: "One-sentence paragraphs", fix: "Every body paragraph needs minimum 3 sentences: Topic sentence → Explanation → Example/Result. One sentence = underdeveloped = Band 5." },
    { peeve: "Copying words from the question", fix: "Paraphrase the introduction. If the question says 'reduce crime', write 'address criminal activity'. Direct copying is penalised." }
  ],
  templates: [
    ...
    { type: "Concession + Rebuttal", template: "Admittedly, [acknowledge opposing view]. However, [counter-argument]. While [opponent's point] may hold some merit, the evidence overwhelmingly suggests that [your point]." },
...
const MainTabBtn = ({ label, active, onClick }) => (
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
                {topic.words.map((pair, j) => (
                  <div key={j} style={{ display:"flex", gap:10, alignItems:"center", flexWrap:"wrap" }}>
                    <span style={{ background:"rgba(239,83,80,0.1)", borderRadius:6, padding:"3px 10px", fontSize:13, color:"#ffcdd2", fontFamily:"system-ui", minWidth:100 }}>✗ {pair[0]}</span>
...
export default function IELTSBot() {
  ...
  const analyze = async () => {
    ...
    try {
      ...
      setResult(parsed); setActiveTab("scores"); setMainView("analyze");
    ...
    <div style={{ minHeight:"100vh", background:"#0d1117", color:"#e0e6f0", paddingBottom:60 }}>
      ...
      <div style={{ background:"linear-gradient(135deg,#0d1117,#161b27)", borderBottom:"1px solid rgba(201,168,76,0.15)", padding:"28px 24px", textAlign:"center" }}>
        ...
        <p style={{ color:"#667", fontSize:13, fontFamily:"system-ui", margin:"8px auto 0", maxWidth:560 }}>
          Task 1 & 2 · Academic & General · Complete mistake detection · Band Booster · IELTS Toolkit
        </p>
      ...
      <div style={{ maxWidth:800, margin:"0 auto", padding:"24px 16px 0" }}>
        ...
        <div style={{ display:"flex", gap:8, marginBottom:24 }}>
          <MainTabBtn label="🎓 Analyze Essay" active={mainView==="analyze"} onClick={()=>setMainView("analyze")} />
          <MainTabBtn label="📚 IELTS Toolkit" active={mainView==="toolkit"} onClick={()=>setMainView("toolkit")} />
        </div>
            ...
            {taskType === "task1academic" && (
              <div style={{ marginBottom:16 }}>
                ...
                <div onClick={() => fileRef.current.click()}
                  ...
                  {imagePreview ? (
                    <div>
                      <img src={imagePreview} alt="uploaded" style={{ maxHeight:200, maxWidth:"100%", borderRadius:8, marginBottom:8 }} />
                      <div style={{ fontSize:12, color:"#00c9a7", fontFamily:"system-ui" }}>✓ Uploaded — click to change</div>
                    </div>
                  ) : (
                    <div>
                      <div style={{ fontSize:32, marginBottom:8 }}>📊</div>
                      <div style={{ fontSize:14, color:"#c9a84c", fontFamily:"system-ui", marginBottom:4 }}>Click to upload graph/chart image</div>
                      <div style={{ fontSize:12, color:"#555", fontFamily:"system-ui" }}>JPG, PNG — the AI will read the graph and evaluate accuracy</div>
                    </div>
                  )}
                </div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
              <div>
                ...
                <textarea value={topic} onChange={e=>setTopic(e.target.value)} rows={3}
                  placeholder={taskType==="task2" ? "e.g. Some people think universities should focus on job skills. Others believe the purpose of a university is to provide knowledge for its own sake. Discuss both views and give your opinion." : taskType==="task1academic" ? "e.g. The graph below shows changes in energy consumption in the US between 1980 and 2020. Summarise the information by selecting and reporting the main features." : "e.g. You recently bought a laptop from an online store but it arrived damaged. Write a letter to the manager. Describe the laptop, explain the damage, and say what you would like them to do."}
            ...
            {result && (
              <div style={{ marginTop:36 }}>
                ...
                <div style={{ display:"flex", gap:6, marginBottom:16, flexWrap:"wrap" }}>
                  ...
                  <TabBtn label="✨ Sample Response" active={activeTab==="sample"} onClick={()=>setActiveTab("sample")} />
                </div>
                ...
                {activeTab==="mistakes" && (
                  <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                    <div style={{ display:"flex", gap:8, flexWrap:"wrap", marginBottom:4 }}>
                      ...
                      <span style={{ color:"#555", fontSize:12, fontFamily:"system-ui", alignSelf:"center" }}>— {result.mistakes?.length} total found</span>
                    </div>
                  ...
                  <div style={{ background:"linear-gradient(135deg,rgba(201,168,76,0.1),rgba(0,201,167,0.05))", border:"1px solid rgba(201,168,76,0.25)", borderRadius:14, padding:"20px 24px" }}>
                    <div style={{ display:"flex", alignItems:"center", gap:16, marginBottom:20, flexWrap:"wrap" }}>
                      ...
                      <div style={{ flex:1, marginLeft:8 }}>
                        <div style={{ fontSize:14, color:"#c9a84c", fontWeight:700, fontFamily:"system-ui" }}>Exactly what to do:</div>
                      </div>
                    </div>
                    <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                ...
                {activeTab==="vocab" && (
                  <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                    <div style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.07)", borderRadius:12, padding:"12px 16px", marginBottom:4 }}>
                      <p style={{ color:"#6b6760", fontSize:13, margin:0, fontFamily:"system-ui", fontStyle:"italic" }}>Weak or basic words from your response — upgraded to Band 7-8 alternatives.</p>
                    </div>
        ...
        {/* TOOLKIT VIEW */}
        {mainView === "toolkit" && <ToolkitContent />}
      </div>
    </div>
  );
}
